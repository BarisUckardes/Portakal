...
namespace Portakal
{
    class RUNTIME_API VulkanUtils
    {
    public:
        FORCEINLINE static VkCompareOp GetCompareOperation(const CompareOperation operation)
        {
            switch (operation)
            {
        ...
        FORCEINLINE static VkLogicOp GetLogicOperation(const LogicOperation operation)
        {
            switch (operation)
            {
