...
namespace Portakal
{
	...
	void MaterialResource::SetMemoryProfile(const SharedHeap<GraphicsMemory>& pHeapDevice, const SharedHeap<GraphicsMemory>& pHeapHost, const SharedHeap<ResourceTablePool>& pPool)
	{
		if (IsShutdown())
			return;
