...
namespace Portakal
{
	...
	{
	public:
		FORCEINLINE static DXGI_FORMAT GetD3DTextureFormat(TextureFormat format)
		{
			switch (format)
			{
		...
		FORCEINLINE static D3D12_RTV_DIMENSION GetD3DRenderTargetViewDimension(TextureType type)
		{
			switch (type)
			{
		...
		FORCEINLINE static D3D12_DSV_DIMENSION GetD3DDepthStencilViewDimension(TextureType type)
		{
			switch (type)
			{
			case TextureType::Texture1D:
		...
		FORCEINLINE static D3D12_SRV_DIMENSION GetD3DShaderResourceViewDimension(TextureType type)
		{
			switch (type)
			{
			case TextureType::Texture1D:
