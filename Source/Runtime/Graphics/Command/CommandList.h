...
namespace Portakal
{
	...
	public:
		...
		void SetIndexBuffer(const SharedHeap<GraphicsBuffer>& pBuffer, const IndexBufferType type);
		...
		void CommitResources(DescriptorSet** ppTables,const UInt32 count);
	...
	protected:
		...
		virtual void SetIndexBufferCore(const GraphicsBuffer* pBuffer, const IndexBufferType type) = 0;
		...
		virtual void CommitResourcesCore(DescriptorSet** ppTables, const UInt32 count) = 0;
